...
single_data = pd.read_csv('./data/SNIPS.csv')
...
tokenset_ratio_map.to_csv('./results/tokenset_ratio_map_SNIPS_1000.csv', index = False)
...
partial_ratio_map.to_csv('./results/partial_ratio_map_SNIPS_1000.csv', index = False)
...
jaccard_ratio_map = pd.DataFrame(zip(full_data.utterance.iloc[0:1000], i1_list, i2_list, i3_list,
                                 ...
                                 columns = ['utterance', 'intent_1', 'intent_2', 'intent_3', 
                                           'score_1', 'score_2', 'score_3', 'sent_1', 'sent_2', 'sent_3',
                                           'actual1', 'actual2', 'actual3'])
jaccard_ratio_map.to_csv('./results/jaccard_ratio_map_SNIPS_1000.csv', index = False)
...
cosine_ratio_map.to_csv('./results/cosine_ratio_map_SNIPS_1000.csv', index = False)
